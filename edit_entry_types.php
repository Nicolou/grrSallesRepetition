 ...
 * @package   root
 * @version   $Id: edit_entry_types.php,v 1.8 2009-06-04 15:30:17 grr Exp $
 * @filesource
 *
...
if ($nb_type > 1) {
	...
	echo "<table width=100%><tr><td class=\"E\"><B>".get_vocab("type")." *".get_vocab("deux_points")."</B></td></tr>\n";
    echo "<tr><td><b>".htmlentities(removeMailUnicode($type_nom_unique))."</b>"."<input name=\"type\" type=\"hidden\" value=\"".$type_id_unique."\" /></td></tr></table>\n";
}
?>