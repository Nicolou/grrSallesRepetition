 ...
 * @package   root
 * @version   $Id: admin_config_ldap.php,v 1.11 2009-04-14 12:59:17 grr Exp $
 * @filesource
 *
...
if ($etape == 3) {
    ...
    <div>Laissez «localhost» si l'annuaire est installé sur la même machine que GRR. Sinon, indiquez l'adresse du serveur.<br />");
    ...
    echo encode_message_utf8("<h3>Type d'accès</h3><div>Si le serveur LDAP n'accepte pas d'accès anonyme,
    ...
    if (getSettingValue("ldap_statut") != '') {
        ...
        if (getSettingValue("ldap_champ_recherche")=='') echo "<br />Le champ ci-dessous ne doit pas être vide.</span>";
        echo "<br />";
