...
$grr_script_name = "admin_AddingForfait.php";
...
if (!isset($_POST['day']) or !isset($_POST['month']) or !isset($_POST['year'])) {	
	echo '<p> date du forfait non d&eacute;termin&eacute;e</p>';
	exit();
}  
...
$req = 'insert into grr_forfait_credit set USER_ID=\'' . $adminUser . '\', USER_DO=\'' . getUserName() . '\' '
	. ', QT=' . $heures . ', BLDT=\'' . $dateForfait . '\'';
