...
$vocab['action'] = "Acción";
$vocab['activer fonctionalité ressource empruntee restituee'] = "Activar la funcionalidad \"recurso prestado/restituido\"";
...
$vocab['Changer_source_utilisateur_local'] = "Marcar la casilla al lado para que la autentificación sea local (da la autentificación externa como Idap, CAS SSO, o Lemonldap definitivamente imposible). ¡Procedimiento irreversible!";
...
<br />
Pour activez cette fonctionnalité, vous devez définir ci-dessous un mot de passe.
...
<br /><b>Il est fortement conseiller de choisir un mot de passe complexe avec lettres, chiffres et caractères spéciaux !</b>"; // A traduire
...
$vocab['montrer_fiche_présentation_ressource'] = "Hacer visible la fecha de presentación del recurso en el interfaz público.";
...
$vocab['suppression automatique des réservations'] = "Método de ejecución automática de tareas";
