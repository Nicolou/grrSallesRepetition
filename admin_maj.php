 ...
 * @package   root
 * @version   $Id: admin_maj.php,v 1.18 2009-04-14 12:59:17 grr Exp $
 * @filesource
 *
...
if (isset($_POST['maj']) or isset($_GET['force_maj'])) {
    ...
    // La version 1.9.6 a introduit un niveau sipplémentaire pour le champ qui_peut_reserver_pour, ce qui oblige à un décalage : les niveaux 5 deviennent des niveaux 6
