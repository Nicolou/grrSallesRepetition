 ...
 * @package   root
 * @version   $Id: view_entry.php,v 1.15 2009-09-29 18:02:57 grr Exp $
 * @filesource
 *
...
$breve_description = bbcode(htmlspecialchars($row[0]),'nobbcode');
...
if ($back != "") echo "<div><a href=\"".$back."\">".get_vocab("returnprev")."</a></div>\n";
