...
$sql = "SELECT nom, prenom, statut, login, etat, source, couleur FROM ".TABLE_PREFIX."_utilisateurs ORDER BY $order_by";
$res = grr_sql_query($sql);
if ($res) {
    for ($i = 0; ($row = grr_sql_row($res, $i)); $i++)
    {
    ...
    //affichage couleur
    echo "<td style=\"background-color:".$tab_couleur[$user_couleur].";\">&nbsp;<\td>\n";
    // 
