 ...
 * @package   root
 * @version   $Id: admin_config4.php,v 1.6 2009-09-29 18:02:56 grr Exp $
 * @filesource
 *
...
if ($dbsys == "mysql") {
    ...
    echo "\n<p><span class=\"avertissement\"><i>Attention! Restaurer la base vous fera perdre toutes les données quelle contient actuellement. De plus, tous les utilisateurs présentement connectés, ainsi que vous-mêmes, serez déconnectés. Alors, il est conseillé de créer d'abord une sauvegarde et de vous assurer que vous êtes le seul connecté.</i></span></p>\n";
    ?>
