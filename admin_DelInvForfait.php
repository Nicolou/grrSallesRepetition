...
$grr_script_name = "admin_DelInvForfait.php";
...
//                -------------------------------------------------------- debut page
echo begin_page('del inv forfait');   
...
$req = 'delete from grr_forfait_archive where ID=' .  $idForfait ;
	

$msg = 'message a afficher par pop pup';	
if (grr_sql_command($req) < 0) {fatal_error(1, "<p>" . grr_sql_error());}  
	else {$msg= 'suppression de l\'inventaire reussi';}
